...
'''
[.text-center]
<<_前言,icon:arrow-circle-left[]>> |
<<_简单时钟系统,icon:arrow-circle-right[]>>
...
[cols="1,1,2,2,3,4", options=header, width=90%]
|===
| _F_ | _G_ | _F_ => _G_ | &not; _F_ | &not; _F_ \/ _G_ | (_F_ => _G_) &equiv; &not; _F_ \/ _G_
| 真 | 真 | 真 | 假 | 真 | 真
| 真 | 假 | 假 | 假 | 假 | 真
| 假 | 真 | 真 | 真 | 真 | 真
| 假 | 假 | 真 | 真 | 真 | 真
